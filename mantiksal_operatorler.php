<?php
    ...
    Mantıksal Operatörler
       ...
       || - or (veya - yada)
       ! (değilse)
     if (eğer parantez koşunu sağlanırsa){         //iki parantez arası true dönerse
         // bu kısım çalışır
     }         //false dönerse bu kısımdaki kodlar calişir.  //doğru koşul
  // $a = 23;
  // $b = 23;     if($a == $b){
         echo "a b'ye eşit";
     ...
     $b = 24;     if($a == $b){
      ...
      }    or || (veya - yada) operatörü     $a = 6;
     $b = 6;
     $c = "Ahmet";
     $d = "Emre";
     $e = "Harun";
     $f = "Mert";     if(($a == $b) ||  ($c == $d) || ($e == $f)){
         echo "Girilen koşulların en az bir tanesi doğru";
     }    ! değilse operatörü     $icerik1 = "Gül";  
     $icerik2 = "gül";
     if($icerik1 != $icerik2){
